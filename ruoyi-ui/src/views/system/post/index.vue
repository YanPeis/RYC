  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="状态" prop="status">
        <el-select v-model="queryParams.status" placeholder="身份状态" clearable>
          <el-option
    ...
    <el-table v-loading="loading" :data="postList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="身份排序" align="center" prop="postSort" />
...
<!--      </el-table-column>-->
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="身份名称" prop="postName">
          <el-input v-model="form.postName" placeholder="请输入身份名称" />
        </el-form-item>
        <el-form-item label="身份编码" prop="postCode">
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除身份编号为"' + postIds + '"的数据项？').then(function() {
